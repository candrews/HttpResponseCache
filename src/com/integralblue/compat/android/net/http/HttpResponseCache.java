...
package com.integralblue.compat.android.net.http;
...
import com.integralblue.compat.libcore.io.DiskLruCache;
import com.integralblue.compat.libcore.io.IoUtils;
...
public final class HttpResponseCache extends ResponseCache implements Closeable {
    ...
    private final com.integralblue.compat.libcore.net.http.HttpResponseCache delegate;

    private HttpResponseCache(File directory, long maxSize) throws IOException {
        this.delegate = new com.integralblue.compat.libcore.net.http.HttpResponseCache(directory, maxSize);
    }
